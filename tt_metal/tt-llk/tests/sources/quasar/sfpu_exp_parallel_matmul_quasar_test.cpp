...
void run_kernel(RUNTIME_PARAMETERS params)
{
    ...
    {
        ZONE_SCOPED("INIT")
        if constexpr (PERF_RUN_TYPE == PerfRunType::L1_TO_L1 || PERF_RUN_TYPE == PerfRunType::L1_TO_L1_PARALLEL || PERF_RUN_TYPE == PerfRunType::MATH_ISOLATE)
        {
...
void run_kernel(RUNTIME_PARAMETERS params)
{
...

    {
        ...
        else if constexpr (PERF_RUN_TYPE == PerfRunType::L1_TO_L1 || PERF_RUN_TYPE == PerfRunType::L1_TO_L1_PARALLEL)
        {
