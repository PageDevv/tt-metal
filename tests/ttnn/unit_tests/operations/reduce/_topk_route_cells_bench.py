...
boundary questions (review #53464): pow2-4096 arm, tiny-width large-k floor,
gate arm at its shipped configuration. One cell per invocation; run under
`python -m tracy -r -v` and sum DEVICE KERNEL DURATION over the report CSV.
